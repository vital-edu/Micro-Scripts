...
class MedicinesControllerTest < ActionController::TestCase
  ...
  test "should create medicine" do
    assert_difference('Medicine.count') do
      post :create, medicine: { amount: @medicine.amount, description: @medicine.description, max_shot: @medicine.max_shot, name: @medicine.name, shot: @medicine.shot }
    end
  ...
  test "should update medicine" do
    patch :update, id: @medicine, medicine: { amount: @medicine.amount, description: @medicine.description, max_shot: @medicine.max_shot, name: @medicine.name, shot: @medicine.shot }
    assert_redirected_to medicine_path(assigns(:medicine))
  end
